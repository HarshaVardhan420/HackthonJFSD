            ...
            <div class="card-body">
                ...
                <form action="studentlogin" method="post">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <img id="captcha" alt="Captcha Image" class="mb-2" src="" onclick="loadcaptcha()" />
                        <input type="text" class="form-control mt-2" id="captchaInput" name="captcha" placeholder="Enter Captcha" required>
                    </div>
